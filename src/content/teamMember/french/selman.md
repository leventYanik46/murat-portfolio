...
metadata:
  ...
  description: Découvrez l’expertise de S. Selman Kilic en contentieux civil, transactions immobilières, gouvernance d’entreprise et enjeux des plateformes numériques. Associé juridique multilingue parlant turc, anglais et français.
profile:
  id: about
  columns: 2
  image:
...
- id: resume
  ...
  - title: University of Minnesota Law School <br /><span class="text-sm font-normal">(2024) – LL.M.</span>
    icon: tabler:school
  - title: Faculté de droit de l’Université Galatasaray <br /><span class="text-sm font-normal">(2016) – LL.B.</span>
    icon: tabler:school
  classes:
    container: max-w-3xl
- id: resume
