...
metadata:
  ...
  description: >-
    Comprehensive estate strategies that preserve wealth, minimize risk, and
    guide family transitions with clarity.
hero:
  tagline: Contact Us
  title: Let's Connect!
  image:
...
contactForm:
  ...
  infoTitle: Estate Planning & Asset Protection
  infoDescription: >-
    Comprehensive estate strategies that preserve wealth, minimize risk, and
    guide family transitions with clarity.
post:
  ...
  content: >
    ...
    <p>Comprehensive estate strategies that preserve wealth, minimize risk, and
    guide family transitions with clarity.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Revocable and irrevocable trusts tailored to your goals</li>
          <li>Asset protection strategies for business owners and professionals</li>
          <li>Tax-aware estate planning, gifting, and lifetime transfers</li>
          <li>Coordination with financial and insurance advisors to implement your plan</li>
        </ul>
