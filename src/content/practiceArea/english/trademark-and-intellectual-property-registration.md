...
contactForm:
  ...
  infoTitle: Trademark and Intellectual Property Registration
  infoDescription: >-
    Protect brand assets with trademark searches, filings, and responses that
    reduce conflicts and speed approvals.
post:
  ...
  content: >
    ...
    <p>Protect brand assets with trademark searches, filings, and responses that
    reduce conflicts and speed approvals.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Clearance searches and risk assessments</li>
          <li>USPTO applications, statements of use, and maintenance filings</li>
          <li>Office action responses and specimen strategy</li>
          <li>Portfolio planning for names, logos, and taglines</li>
        </ul>
