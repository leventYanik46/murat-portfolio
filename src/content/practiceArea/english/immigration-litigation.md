...
metadata:
  ...
  description: >-
    Federal and administrative litigation to challenge denials, delays, and
...
contactForm:
  ...
  infoTitle: Immigration Litigation
  infoDescription: >-
    Federal and administrative litigation to challenge denials, delays, and
    adverse immigration decisions.
post:
  ...
  content: >
    ...
    <p>Federal and administrative litigation to challenge denials, delays, and
    adverse immigration decisions.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Mandamus actions for unreasonable delays</li>
          <li>APA challenges to denials and revocations</li>
          <li>Appeals and motions to reopen/reconsider</li>
          <li>Strategic coordination with underlying petitions and waivers</li>
        </ul>
