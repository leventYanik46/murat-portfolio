---
metadata:
  title: 'Property Acquisitions, Leasing, and Development'
  description: >-
...
contactForm:
  ...
  infoTitle: 'Property Acquisitions, Leasing, and Development'
  infoDescription: >-
    Strategic guidance for acquisitions, leasing, and development projects to
    keep investments on track.
post:
  ...
  content: >
    ...
    <p>Strategic guidance for acquisitions, leasing, and development projects to
    keep investments on track.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Commercial and residential purchase agreements</li>
          <li>Ground, retail, office, and industrial leases</li>
          <li>Development agreements, entitlements, and permits</li>
          <li>Construction contracts and risk allocation</li>
        </ul>
