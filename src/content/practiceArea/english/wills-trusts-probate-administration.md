...
post:
  ...
  content: >
    ...
    <p>Plain-English wills and trusts backed by efficient probate administration
    to honor intent and protect heirs.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Custom wills, trusts, and beneficiary designations</li>
          <li>Probate guidance, filings, and estate accounting</li>
          <li>Trust funding, administration, and trustee support</li>
          <li>Dispute avoidance strategies and clear communication with heirs</li>
        </ul>
