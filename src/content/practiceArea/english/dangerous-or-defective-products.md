---
metadata:
  title: Dangerous or Defective Products
  description: >-
    Product liability claims that target defective design, manufacture, or
    warnings to recover for injuries.
hero:
  tagline: Contact Us
  title: Let's Connect!
  image:
...
contactForm:
  ...
  infoTitle: Dangerous or Defective Products
  infoDescription: >-
    Product liability claims that target defective design, manufacture, or
    warnings to recover for injuries.
post:
  ...
  content: >
    ...
    <p>Product liability claims that target defective design, manufacture, or
    warnings to recover for injuries.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Design, manufacturing, and failure-to-warn theories</li>
          <li>Expert coordination and evidence preservation</li>
          <li>Insurance coverage and third-party liability analysis</li>
          <li>Settlement strategy and litigation to verdict</li>
        </ul>
