...
metadata:
  ...
  description: >-
    Keep confidential know-how protected with policies, agreements, and
    enforcement plans.
hero:
  tagline: Contact Us
  title: Let's Connect!
...
contactForm:
  ...
  infoTitle: Trade Secret Protection
  infoDescription: >-
    Keep confidential know-how protected with policies, agreements, and
    enforcement plans.
post:
  title: Trade Secret Protection
  image: ~/assets/images/trade-secret-protection.jpg
  content: >

    <p>Keep confidential know-how protected with policies, agreements, and
    enforcement plans.</p>
    ...
    <ul>
          <li>NDAs, confidentiality policies, and access controls</li>
          <li>Employee and contractor onboarding/offboarding protocols</li>
          <li>Incident response for suspected misappropriation</li>
          <li>Litigation readiness and evidence preservation</li>
        </ul>
