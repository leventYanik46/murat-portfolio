...
metadata:
  title: I Vizesi
  description: >-
    Görevle ABD'ye gelen yabancı medya temsilcileri için basın (I) vizeleri.
hero:
  tagline: Bize Ulaşın
  title: Bağlanalım!
  image:
...
contactForm:
  ...
  infoTitle: I Vizesi
  infoDescription: >-
    I Vizesi uygunluğu, dilekçe taslağı, kanıt ve mülakat hazırlığı için uçtan uca destek.
  googleReview:
...
post:
  ...
  content: >
    ...
    <p>I Vizesi hizmetlerimiz, uygunluk, dilekçe stratejisi ve kanıt hazırlığında sizi yönlendirir, sürecin rayında kalmasını sağlar.</p>
    ...
    <p>Arka planınızı I Vizesi kriterleriyle eşleştiriyor, zaman çizelgesi, riskler ve sonraki adımları net bir planla belirliyoruz.</p>
    ...
    <p>Odaklı ve stratejik temsil; I Vizesi sürecinizin her aşamasında sizi bilgilendirir ve hazır tutar.</p>
---
