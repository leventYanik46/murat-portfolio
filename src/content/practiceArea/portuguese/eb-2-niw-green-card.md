...
metadata:
  ...
  description: >-
    Petições de Dispensa por Interesse Nacional (NIW) para profissionais com pós-graduação e pessoas de habilidade excepcional.
hero:
...
contactForm:
  ...
  infoDescription: >-
    Suporte completo para Green Card EB-2 NIW: elegibilidade, petição, provas e preparação para entrevista.
  googleReview:
...
post:
  ...
  content: >
    ...
    <p>Nossos serviços de Green Card EB-2 NIW orientam você na elegibilidade, estratégia de petição e preparação de provas, mantendo o caso nos trilhos.</p>
    ...
    <ul>
      <li>Revisão de elegibilidade e estratégia de documentação</li>
      <li>Preparação de formulários, cartas de apoio e organização de provas</li>
      <li>Preparação para entrevista e consulado com orientação jurídica</li>
      <li>Respostas a RFE/NOID e apoio de compliance após a aprovação</li>
    </ul>

    <h3>Divisão do Serviço</h3>

    <h3>Elegibilidade e Estratégia</h3>
    <p>Alinhamos seu perfil aos critérios de Green Card EB-2 NIW, definindo prazos, riscos e próximos passos com um plano claro.</p>
    ...
    <p>Representação focada e estratégica que mantém você informado e pronto em cada etapa do seu processo de Green Card EB-2 NIW.</p>
---
