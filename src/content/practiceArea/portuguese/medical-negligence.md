...
metadata:
  ...
  description: >-
    Responsabilizando prestadores por erros médicos evitáveis com construção
    meticulosa de casos.
hero:
...
post:
  ...
  content: >
    ...
    <p>Responsabilizando prestadores por erros médicos evitáveis com construção de
    casos meticulosa.</p>
    ...
    <ul>
      <li>Triagem de casos com especialistas médicos</li>
      <li>Análise do padrão de cuidado e comprovação de causalidade</li>
      <li>Negociação com seguradoras e advogados hospitalares</li>
      <li>Preparação para julgamento quando o acordo não é suficiente</li>
    </ul>
