...
"announcement": Record<string, {
  id: string;
  body?: string;
  collection: "announcement";
  data: InferEntrySchema<"announcement">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
"confirmation": Record<string, {
  id: string;
  render(): Render[".md"];
  slug: string;
  body: string;
  collection: "confirmation";
  data: InferEntrySchema<"confirmation">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
...
"practiceArea": Record<string, {
  id: string;
  body?: string;
  collection: "practiceArea";
  data: InferEntrySchema<"practiceArea">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
